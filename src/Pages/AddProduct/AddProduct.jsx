...
const AddProduct = () => {
    const handleAddProduct = (event) => {
        ...
        console.log(food_name, pic, category, quantity, price, origin, description)
        ...
        fetch('https://restaurent-management-server-side-ltybsoexv.vercel.app/items', {
            method: 'POST',
            headers: {
    ...
    return (
        <div>
            <div>
                <h1 className="text-6xl font-bold text-center">Add a <span className="text-stone-400-700">Car</span></h1>
            </div>
